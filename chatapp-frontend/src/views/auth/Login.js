    ...
    return (
        <div className="min-h-screen flex bg-gray-100">
            <div className="w-1/3 bg-gradient-to-b from-green-400 via-orange-500 to-red-500 flex flex-col justify-center items-center text-white p-10 space-y-5">
                ...
                <p className="text-lg font-medium">Connect, converse, and collaborate with friends and colleagues.</p>
                {/* <img src="/path_to_some_chat_illustration.png" alt="Chat illustration" className="w-2/3 h-auto"/> */}
            </div>
            <div className="w-2/3 flex items-center justify-center">
                <div className="bg-white p-12 rounded-xl shadow-2xl w-2/3 space-y-6">
                    <h2 className="text-3xl font-bold mb-5 text-gray-700">Welcome Back!</h2>
                    ...
                    <p className="mt-4 text-center text-gray-600">Don't have an account? <Link to="/signup" className="text-blue-500 hover:underline">Sign Up</Link></p>
                </div>
            </div>
        </div>
    );
